...
#     }
#   }
execute as @e[type=minecraft:player,distance=..29.999999] at @s run execute if score --use_thrown-find_owner-found --use_thrown--vars matches 0 run function zzz_mcl:use_thrown/9_k8f98bl3159
# unless ($found) else()
